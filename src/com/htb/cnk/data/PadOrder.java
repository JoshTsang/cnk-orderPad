...
public class PadOrder {
	...
	public class OrderedDish {
		...
		public OrderedDish(Dish dish, int quantity, int tableId) {
			this.dish = dish;
		...
		public OrderedDish(Dish dish, int quantity, int id, int type,
				int tableId) {
			this.dish = dish;
			this.quantity = quantity;
			this.orderDishId = id;
	...
	public PadOrder(Context context) {
	...
	public int add(Dish dish, int quantity, int tableId) {
		...
		mOrder.add(new OrderedDish(dish, quantity, tableId));
		return 0;
	}
	...
	public int addItem(Dish dish, int quantity, int id, int type, int tableId) {
		...
		mOrder.add(new OrderedDish(dish, quantity, id, type, tableId));
		return 0;
	}
...
//		Log.d("conut", "count:"+count());
//		int count = count();
//		for (int i = 0; i < count;) {
//			Log.d("type", "type:"+mOrder.get(i).getType()+" i:"+i);
//			if (mOrder.get(i).getType() == MODE_PHONE) {
//				Log.d("mOrder", "iii:"+i);
//				mOrder.remove(i);
//				i=0;
//				count = count();
...
//		for (int i = 0; i < count;) {
//			Log.d("type", "type:"+mOrder.get(i).getType()+" i:"+i);
//			if (mOrder.get(i).getType() == MODE_PAD) {
//				Log.d("mOrder", "iii:"+i);
//				mOrder.remove(i);
//				i=0;
//				count = count();
	...
	public int getTableFromDB(int tableId) {
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				addItem(mDish, quantity, tableId, MODE_PAD, tableId);
			}
			return 0;
		} catch (Exception e) {
			e.printStackTrace();
